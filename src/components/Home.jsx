    ...
    <div name="home" className="bg-[#0a192f] w-full h-screen">
      ...
      <div className="container flex flex-col lg:flex-row items-center justify-center h-full mx-auto space-y-20 lg:space-x-20">
        <div className="max-w-[1000px] px-8 flex flex-col justify-center lg:h-full">
          ...
          <div>
            <button className="text-white group border-2 px-6 py-3 my-2 flex items-center mx-auto lg:mx-0 hover:bg-pink-600 hover:border-pink-600">
              View Work
        ...
        <div>
          <div>
            <img
              className="w-64 h-64"
              src="https://avatars.githubusercontent.com/u/97243089?v=4"
              alt=""
            />
          </div>
        </div>
